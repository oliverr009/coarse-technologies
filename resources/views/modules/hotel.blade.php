...
.floor-label{font-size:12px;font-weight:900;color:#919aaa;text-transform:uppercase;letter-spacing:.12em;margin:16px 0 9px}.room-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(136px,1fr));gap:10px}.room-tile{position:relative}.room-tile>summary{list-style:none}.room-tile>summary::-webkit-details-marker{display:none}
.room-btn{min-height:118px;width:100%;border:1.7px solid var(--border);border-radius:9px;background:#fff;color:#172047;cursor:pointer;padding:0;text-align:left;transition:.16s ease;overflow:hidden;display:grid;grid-template-rows:34px 1fr}.room-btn:hover{transform:translateY(-3px);box-shadow:0 14px 30px rgba(0,0,0,.14)}.room-tile[open] .room-btn{box-shadow:0 0 0 3px rgba(40,188,238,.20),0 14px 34px rgba(0,0,0,.16)}
.room-head{display:flex;align-items:center;justify-content:space-between;gap:7px;padding:7px 8px;color:#fff}.room-head-left{font-size:10px;font-weight:900;letter-spacing:.04em;text-transform:uppercase;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.room-head-right{display:flex;align-items:center;gap:6px}.room-code{height:18px;padding:3px 7px;border-radius:5px;background:rgba(0,0,0,.28);font-size:9px;font-weight:900;letter-spacing:.05em}.room-light{width:22px;height:22px;border-radius:7px;background:rgba(255,255,255,.18)}
.room-body{display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:10px 8px 12px}.room-num{font-size:18px;font-weight:900;font-family:'Space Mono',monospace;line-height:1;color:#172047}.room-type{font-size:10px;color:#64748b;margin-top:7px;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.room-guest{font-size:10px;color:#334155;margin-top:5px;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.room-rate{font-size:10px;color:#64748b;margin-top:3px}
.room-btn.st-vacant_clean{border-color:#22c55e}.room-btn.st-vacant_clean .room-head{background:#16a34a}.room-btn.st-vacant_clean .room-num,.room-btn.st-vacant_clean .room-guest{color:#15803d}
.room-btn.st-occupied{border-color:#ef4444}.room-btn.st-occupied .room-head{background:#dc2626}.room-btn.st-occupied .room-num,.room-btn.st-occupied .room-guest{color:#b91c1c}
.room-btn.st-reserved{border-color:#3b82f6}.room-btn.st-reserved .room-head{background:#2563eb}.room-btn.st-reserved .room-num,.room-btn.st-reserved .room-guest{color:#1d4ed8}
.room-btn.st-dirty{border-color:#8b5cf6}.room-btn.st-dirty .room-head{background:#7c3aed}.room-btn.st-dirty .room-num,.room-btn.st-dirty .room-guest{color:#6d28d9}
.room-btn.st-out_of_order{border-color:#b91c1c}.room-btn.st-out_of_order .room-head{background:#991b1b}.room-btn.st-out_of_order .room-num,.room-btn.st-out_of_order .room-guest{color:#991b1b}
.badge{display:inline-flex;align-items:center;padding:5px 9px;border-radius:999px;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:.05em;border:1px solid transparent}.is-occ{background:rgba(248,113,113,.18);color:var(--red);border-color:rgba(248,113,113,.42)}.is-rsv{background:rgba(59,130,246,.18);color:#60a5fa;border-color:rgba(59,130,246,.42)}.is-clean{background:rgba(34,197,94,.20);color:#22c55e;border-color:rgba(34,197,94,.42)}.is-dirty{background:rgba(139,92,246,.20);color:#a78bfa;border-color:rgba(139,92,246,.42)}.is-oos{background:rgba(153,27,27,.24);color:#fecaca;border-color:rgba(153,27,27,.45)}
                        ...
                        @foreach($floorRooms as $room)
                            ...
                            <details class="room-tile">
                                <summary class="room-btn st-{{ $room->status }}">
                                    <div class="room-head">
                                        <div class="room-head-left">{{ $room->room_number }}</div>
                                        <div class="room-head-right">
                                            <span class="room-code">{{ match($room->status) {'occupied' => 'OCP', 'reserved' => 'RES', 'dirty' => 'DIRTY', 'out_of_order' => 'OOO', default => 'VAC'} }}</span>
                                    ...
                                    <div class="room-body">
                                        ...
                                        <div class="room-guest">{{ $room->active_guest_name ?: match($room->status) {'dirty' => 'Vacant Dirty', 'reserved' => 'Reserved', 'out_of_order' => 'Maintenance', default => 'Vacant Clean'} }}</div>
