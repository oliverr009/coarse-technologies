...
.room-btn{min-height:118px;width:100%;border:2px solid var(--border);border-radius:17px;background:rgba(255,255,255,.03);color:var(--text);cursor:pointer;padding:12px;text-align:left;transition:.16s ease;display:flex;flex-direction:column;justify-content:space-between}.room-btn:hover{transform:translateY(-3px);box-shadow:0 16px 34px rgba(0,0,0,.18)}.room-tile[open] .room-btn{border-color:rgba(40,188,238,.45);box-shadow:0 0 0 3px rgba(40,188,238,.10)}
...
.badge{display:inline-flex;align-items:center;padding:4px 8px;border-radius:999px;font-size:9px;font-weight:800;text-transform:uppercase;letter-spacing:.05em}.is-occ{background:rgba(62,207,142,.13);color:var(--green);border-color:rgba(62,207,142,.22)}.is-rsv{background:rgba(255,191,71,.13);color:var(--gold)}.is-clean{background:rgba(40,188,238,.13);color:var(--blue)}.is-dirty{background:rgba(248,113,113,.13);color:var(--red)}.is-oos{background:rgba(148,163,184,.18);color:#cbd5e1}
...
@media(max-width:1320px){.pms-stats{grid-template-columns:repeat(3,1fr)}.pms-actions-bar{grid-template-columns:repeat(3,1fr)}.pms-main{grid-template-columns:1fr}.pms-action-menu{width:calc(100vw - 120px);left:0!important;right:auto!important}}@media(max-width:820px){.pms-stats,.pms-actions-bar,.pms-form-grid,.pms-mini-grid,.pms-inline{grid-template-columns:1fr}.room-pop{position:static;width:100%;margin-top:10px}.pms-action-menu{position:static;width:100%;margin-top:8px}}
</style>
    ...
    <div class="pms-actions-bar">
        ...
        <details class="pms-action">
            ...
            <div class="pms-action-menu">
                ...
                <div class="pms-note" style="margin-top:10px">This is the setup area for room types, rates, occupancy, room inventory, and room status controls. Full create/edit setup forms can be added here next.</div>
            </div>
        </details>
